...
// Import the shared CSS for styling
import "./MensFashionContent.css"; // Reuse the CSS from MensFashionContent

function WomensFashionContent() {
...
export default WomensFashionContent;
